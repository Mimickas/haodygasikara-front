...
export default function FooterClient() {
    ...
    return (
        <footer style={{ backgroundColor: "var(--bg-dark)" }}>
            <div className="max-w-6xl mx-auto px-8 py-14">
                <div className="flex justify-between gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="font-body text-sm leading-relaxed max-w-xs" style={{ color: "var(--text-inverse-muted)" }}>
                    ...
                    <div className="flex flex-col gap-3">
                        <h3 className="font-body-strong text-base mb-1" style={{ color: "var(--text-inverse)" }}>
                            Nous contacter
                        </h3>
                        <p className="font-body text-sm leading-relaxed" style={{ color: "var(--text-inverse-muted)" }}>
            ...
            <div>
                <div className="mt-2 p-6 text-center" style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
                    <p className="font-body text-xs" style={{ color: "var(--text-inverse-muted)" }}>
